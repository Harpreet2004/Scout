...
import { clearAllJobErrors, deleteMyJob, getMyJobs, resetJobSlice } from '../store/slices/jobSlice';
            ...
            <div className="applications_container">
              {myJobs.map((element) => (
                <div className="card" key={element._id}>
                  ...
                  <p className="sub-sec">
                    <span>Introduction:</span> {element.jobDescription}
                  </p>
                  <p className="sub-sec">
                  ...
                  {element.offers && (
                    <p className="sub-sec">
                      <span>What Are We Offering:</span> {element.perks}
                    </p>
                  )}
                  <button
                    className="btn"
